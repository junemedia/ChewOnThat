...
<meta name="google-site-verification" content="54tKhlSzsEZN2dt0Q3ZeMlDdfzBoS9ZnOrrOkK4ltJI" />
...
<script type="text/javascript">
  GS_googleAddAdSenseService("ca-pub-7049968558998359");
  GS_googleEnableAllServices();
</script>
<script type="text/javascript">
  //GA_googleAddSlot("ca-pub-7049968558998359", "ChewOnThat_FullPost_300x250");
  //GA_googleAddSlot("ca-pub-7049968558998359", "ChewOnThat_RON_160x600");
  //GA_googleAddSlot("ca-pub-7049968558998359", "ChewonThat_RON_728x90");
  GA_googleAddSlot("ca-pub-7049968558998359", "ChewOnThat_RON_300x250");
  //GA_googleAddSlot("ca-pub-7049968558998359", "ChewonThat_RON2_300x250");
</script>
<script type="text/javascript">
  GA_googleFetchAds();
</script>
<!-- END OF TAG FOR head SECTION -->
<meta name="google-site-verification" content="HOEZNwttHBPZpprT7hwFKPFPGogUOW4UINXWVd1spek" />
</head>
<body>
<div id="mainframe">
	<!--<div id="top">
		<div class="form">
		<form action="http://www.feedburner.com/fb/a/emailverify" method="post" target="popupwindow" onsubmit="window.open('http://www.feedburner.com/fb/a/emailverifySubmit?feedId=666943', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true">
		<input type="text" name="email" class="text" />
		<input type="hidden" value="http://feeds.feedburner.com/~e?ffid=666943" name="url"/><input type="hidden" value="Chew On That" name="title"/><input type="hidden" name="loc" value="en_US"/>
		<input type="submit" value="Sign up for E-mail Updates" class="button fix"/>
		</form>		
		</div>
		<div class="feed"><p>Subscribe to our feed</p><a target="_blank" href="<?//bloginfo('rss2_url'); ?>"><img src="<?//bloginfo("template_url")?>/images/rss.gif" alt="RSS" /></a></div>
...
<meta name="verify-v1" content="PceBPtt84ynHQpDko9c3YrUt/f2eeAhNwAFG2ZMYzNE=" >
