...
<?php $sandbox_comment_alt = 0 ?>
				...
				<div id="comments-list" class="comments">
					<h3><?php printf(__($comment_count > 1 ? '<span>%d</span> Comments so far (<a class="comment-link" href="#respond" title="Post a comment">Add 1 more</a>)' : '<span>One</span> Comment', 'sandbox'), $comment_count) ?></h3>
...
<div class="bubble">
<div class="<?php if ($comment->comment_author_email == "author@mail.com") echo 'commenttext-admin'; else echo 'commenttext'; ?>">
<blockquote><?php comment_text() ?></blockquote>
</div><!-- end of commenttext-admin -->


<cite>
<a href="#comment-<?php comment_ID() ?>" title="Permalink to this comment"><?php echo $i; ?></a>. <strong><?php comment_author_link() ?></strong> on <?php comment_date('F jS, Y') ?> at <?php comment_time() ?> <?php edit_comment_link('edit','',''); ?> 
