...
function capcc_loadsettings()
{
	...
	$settings['CAPCC_LINES']=	capcc_getoption("CAPCC_LINES",10);
	...
	$settings['CAPCC_FORM']=capcc_getoption("CAPCC_FORM",'<p><input type="hidden" name="capcc_captchakey" value="%KEY%"><img src="%PATH%?r=%KEY%" alt="Captcha" /><br>Enter the letters you see above.<br><input type="text" name="capcc_captcha"></p>');
...
function capcc_loaddefaults()
{
	...
	$settings['CAPCC_FORM']='<p><input type="hidden" name="capcc_captchakey" value="%KEY%"><img src="%PATH%?r=%KEY%" alt="Captcha" /><br>Enter the letters you see above.<br><input type="text" name="capcc_captcha"></p>';
...
if(function_exists('add_action'))
{
	...
	switch($capcc_settings['CAPCC_MODE'])
	{
		case "1":
			...
			//add_action('comment_form','capcc_showform',20);
		...
		break;
		case "3":
			//add_action('register_form','capcc_showform',20);
			add_action('register_post','capcc_validateregister');
		break;
	}
}
